    ...
    <section id="three">
      <main className="ProjectPage">
        ...
        <div className="allProjects">
          <Link className="projectPage-link" to="/projects/FoodOrdering"><img id="FoodOrdering" src="https://i.imgur.com/IOS0IH9.png" alt="Matcha & Co" data-aos="fade-right"></img></Link>
          <div className="project-info-container" data-aos="fade-left">
            <span>Matcha & Co.</span>
            <br></br>
            <span>Food Ordering Website</span>
            <br></br>
            <span>HTML | CSS | JavaScript | MongoDB | Express | React | Node | Slack | Stripe Checkout</span>
            <h3 className="project-info">Matcha & Co. is a full-stack food ordering web application where users can browse a menu, add items to their cart, and place orders through a secure checkout flow.</h3>
          </div>
