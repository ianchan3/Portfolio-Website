  ...
  return (
    <main className="NavBar">
      ...
      <nav>
        ...
        <a href="https://github.com/ianchan3/" target="blank" id="icon"class="icon icon--github--navbar">
          <i id="icon" class="ri-github-line"></i>
        </a>
        <a href="https://www.linkedin.com/in/ianchan-/" target= "blank" id="icon"class="icon icon--linkedin--navbar">
